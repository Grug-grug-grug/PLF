...
ds_list_add(menu, "Level 1", "Level 2", "Credits", "Exit Game");	// the menu items, add or remove items to customize
...
menu_confirmation_buttom = vk_space;	// the buttom to confirm the menu item selected
